...
function LandingPage() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-700 to-teal-700 min-h-screen flex flex-col items-center">
      ...
      <h1 className="bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-blue-400 text-center text-6xl max-sm:text-5xl md:text-7xl tracking-widest"><ColoredLine color="white" />
      PARKING SYSTEM
